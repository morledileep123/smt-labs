...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>@section('title', 'Logout')</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="{{asset('assets/images/smt.jpg')}}" alt="" height="28"> <span class="logo-txt">SMT LABS</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-4 pt-2">
                                                <h5>You are Logged Out Dear</h5>
                                                <p class="text-muted font-size-15">Thank you for using <span class="fw-semibold text-dark">SMT LABS</span></p>
                                                <div class="mt-4">
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> SMT LABS   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                    </div>
                                </div>
                            </div>
                        </div>
